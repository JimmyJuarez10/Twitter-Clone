...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "cY6AdRo3sSYcNDsTuL26wqXZ2", consumerSecret: "tbXQ54FOnywzPZL0NjtbbdQK9jMRoyXpdJBqok4kx8LFpJfxTN")
    var loginSuccess: (() -> ())?
